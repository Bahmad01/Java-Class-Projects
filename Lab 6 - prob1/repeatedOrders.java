public class repeatedOrders extends orderSystem
{
 private int Period;
 private int EndDate;
   ...
   public repeatedOrders() {
       this.Period = 0;
       this.EndDate = 0;
   }

   // non-default Constructor
   public repeatedOrders(String customerID, int productID, int dateOfOrder, int monthOfOrder,
